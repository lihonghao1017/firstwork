...
public class InitCH340 {
    ...
    private static ReadDataRunnable.ReadCallBack mReadCallBack;
    public static  int ProductId,VendorId;
    ...
    public static void setReadCallBack(ReadDataRunnable.ReadCallBack readCallBack){
    ...
    private static void configParameters() {
        ...
        if (isSetConfig) {
            ...
            if (readDataRunnable == null) {
                readDataRunnable = new ReadDataRunnable(mReadCallBack);
            }
